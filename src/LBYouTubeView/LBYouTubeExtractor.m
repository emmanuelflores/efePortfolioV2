        ...
        if (decodingError) {
            ...
            *error = decodingError;
            ...
            if (streamURL) {
                ...
                *error = [NSError errorWithDomain:kLBYouTubePlayerExtractorErrorDomain code:2 userInfo:@{NSLocalizedDescriptionKey: @"Couldn't find the stream URL."}];
            }
        }
    }
    else {
        *error = [NSError errorWithDomain:kLBYouTubePlayerExtractorErrorDomain code:3 userInfo:@{NSLocalizedDescriptionKey: @"The JSON data could not be found."}];
    }
